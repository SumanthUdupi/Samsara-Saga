...
(4, 'Ancient Banyan Grove', 'You stand amidst a grove of ancient Banyan trees, whose aerial roots have created a labyrinth of woody columns. The canopy is so dense that sunlight dapples the floor in shifting patterns, and a deep, peaceful silence reigns.'),
