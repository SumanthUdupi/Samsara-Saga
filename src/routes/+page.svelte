<script lang="ts">
  ...
  const questions = [
    ...
    { text: "To restore a fallen kingdom, what is your first act? A grand, inspiring ritual to rally the people, or a swift, practical action to secure the food stores?", choices: [ { text: "A grand ritual.", nature: 'Ordinary' }, { text: "A practical action.", nature: 'Short' } ] },
    { text: "A powerful but tormented soul asks for your help. Do you destroy the source of its torment, a cursed artifact, or do you guide the soul to find peace despite its pain?", choices: [ { text: "Destroy the artifact.", nature: 'Ferocious' }, { text: "Guide the soul.", nature: 'Gentle' } ] },
  ];
