...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    ...
    imports = ["_app/immutable/nodes/0.CYMCtZ1e.js", "_app/immutable/chunks/CQGUKtNg.js", "_app/immutable/chunks/IHki7fMi.js"];
    stylesheets = ["_app/immutable/assets/0.C6G_3qQV.css"];
    fonts = [];
  }
});
...
var ATTR_REGEX, CONTENT_REGEX, is_legacy, getStores, page, Error$1;
...
var init__2 = __esm({
  ".svelte-kit/output/server/nodes/1.js"() {
    ...
    imports2 = ["_app/immutable/nodes/1.tAvbyUtM.js", "_app/immutable/chunks/CQGUKtNg.js", "_app/immutable/chunks/IHki7fMi.js", "_app/immutable/chunks/2_W7JxVb.js"];
    stylesheets2 = [];
    fonts2 = [];
  }
});
  ...
  try {
    ...
    if (info.type === "command") {
      ...
      return json(
        /** @type {RemoteFunctionResponse} */
        {
          type: "result",
          result: stringify2(data2, transport),
          refreshes: stringify2({ ...get_event_state(event).refreshes, ...refreshed }, transport)
        }
      );
    }
    ...
    if (error2 instanceof Redirect) {
      ...
      return json({
        ...
        refreshes: Object.keys(refreshes).length > 0 ? stringify2(refreshes, transport) : void 0
      });
    }
    return json(
      /** @type {RemoteFunctionResponse} */
